...
const Bills = () => {
  ...
  const handleDelete = async () => {
    ...
    let data;
    if (selectedRow?.length === billsList?.length) {
      data = await deleteAllBills();
    } else {
      data = await deleteBill(selectedRow);
    }
    ...
    <div className="estimate-wrapper tw-mt-16">
      ...
      <div className="dashboard">
        <DashboardNavbar
          ...
          handleNavigation={() => navigate(`edit-bill/${selectedRow[0]?._id}`)}
      ...
      <div className="tw-h-d tw-px-14 tw-mt-2.5 tw-w-[80vw]">
        {billsList && (
          <Table
            ...
            handleNavigation={(e) => navigate(`/purchases/bills/${e.row.id}`)}
